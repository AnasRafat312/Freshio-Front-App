...
export class AppLayoutComponent implements OnDestroy {
    ...
    constructor(
        ...
        private sharedService:SharedService,)
     {
        ...
        this.privilege.getUserRoleInCompanyAndPrivilege().subscribe(
            (data :any) => {
              if (data.IsThereException) {
                ...
                this.privilege.updatCheckedPrivilegeList(this.privilege.getPages(data));
              }

            },
            (err: any) => {
              //this.toastr.error('Error occures while selecting a complate')
            }
          );
