 ...
 * 2. Handle 401 Unauthorized responses and redirect to login
 * 
 * Note: Refresh token logic is commented out - using simple token from localStorage
 */
@Injectable()
export class JwtInterceptor implements HttpInterceptor {
  // COMMENTED OUT - Refresh token logic disabled
  // /**
   ...
   * 3. Handle request
   * 4. On 401 error, redirect to login (refresh token logic commented out)
   * 
   ...
   * Attaches Bearer token to request if available from localStorage
   * 
